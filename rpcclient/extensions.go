...
func (c *Client) DebugLevelAsync(levelSpec string) FutureDebugLevelResult {
	cmd := abejson.NewDebugLevelCmd(levelSpec)
...
func (c *Client) CreateEncryptedWalletAsync(passphrase string) FutureCreateEncryptedWalletResult {
	cmd := abejson.NewCreateEncryptedWalletCmd(passphrase)
	return c.sendCmd(cmd)
}
...
func (r FutureListAddressTransactionsResult) Receive() ([]abejson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (r FutureGetBestBlockResult) Receive() (*chainhash.Hash, int32, error) {
	...
	var bestBlock abejson.GetBestBlockResult
...
func (c *Client) GetBestBlockAsync() FutureGetBestBlockResult {
	cmd := abejson.NewGetBestBlockCmd()
	return c.sendCmd(cmd)
}
...
func (r FutureGetCurrentNetResult) Receive() (wire.AbelianNet, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	return wire.AbelianNet(net), nil
}
...
func (c *Client) GetCurrentNetAsync() FutureGetCurrentNetResult {
	cmd := abejson.NewGetCurrentNetCmd()
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a btcd extension.
func (c *Client) GetCurrentNet() (wire.AbelianNet, error) {
...
func (c *Client) GetHeadersAsync(blockLocators []chainhash.Hash, hashStop *chainhash.Hash) FutureGetHeadersResult {
	...
	cmd := abejson.NewGetHeadersCmd(locators, hash)
	return c.sendCmd(cmd)
}
...
func (c *Client) ExportWatchingWalletAsync(account string) FutureExportWatchingWalletResult {
	cmd := abejson.NewExportWatchingWalletCmd(&account, abejson.Bool(true))
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the
// session result.
func (r FutureSessionResult) Receive() (*abejson.SessionResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var session abejson.SessionResult
...
//
// NOTE: This is a btcsuite extension.
func (c *Client) Session() (*abejson.SessionResult, error) {
...
// NOTE: This is a btcsuite extension ported from
// github.com/decred/dcrrpcclient.
func (r FutureVersionResult) Receive() (map[string]abejson.VersionResult,
	error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
...
// NOTE: This is a btcsuite extension ported from
// github.com/decred/dcrrpcclient.
func (c *Client) Version() (map[string]abejson.VersionResult, error) {
