...
func (c *Client) GetBlockAsync(blockHash *chainhash.Hash) FutureGetBlockResult {
	...
	cmd := abejson.NewGetBlockCmd(hash, abejson.Bool(false), nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockVerboseAsync(blockHash *chainhash.Hash) FutureGetBlockVerboseResult {
	...
	cmd := abejson.NewGetBlockCmd(hash, abejson.Bool(true), nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockVerboseTxAsync(blockHash *chainhash.Hash) FutureGetBlockVerboseResult {
	...
	cmd := abejson.NewGetBlockCmd(hash, abejson.Bool(true), abejson.Bool(true))
	return c.sendCmd(cmd)
}
...
// See GetBlock to retrieve a raw block instead.
func (c *Client) GetBlockVerboseTx(blockHash *chainhash.Hash) (*abejson.GetBlockVerboseResult, error) {
...
//	todo(ABE): ABE does mot support filter.
//// Receive waits for the response promised by the future and returns the raw
