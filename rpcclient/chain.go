...
func (c *Client) GetBestBlockHashAsync() FutureGetBestBlockHashResult {
	cmd := abejson.NewGetBestBlockHashCmd()
...
/*func (c *Client) legacyGetBlockRequest(hash string, verbose,
	...
	verboseJSON, err := json.Marshal(abejson.Bool(verbose))
	if err != nil {
		return nil, err
	}
	verboseTxJSON, err := json.Marshal(abejson.Bool(verboseTx))
	if err != nil {
		return nil, err
	}
...
func (c *Client) legacyGetBlockAbeRequest(hash string, verbose,
	...
	return c.RawRequest("getblockabe", []json.RawMessage{
		hashJSON, verboseJSON, verboseTxJSON,
	})
}
...
/*func (c *Client) waitForGetBlockRes(respChan chan *response, hash string,
	...
	if err, ok := err.(*abejson.RPCError); ok &&
		err.Code == abejson.ErrRPCInvalidParams.Code {
...
func (c *Client) waitForGetBlockAbeRes(respChan chan *response, hash string,
	...
	if err, ok := err.(*abejson.RPCError); ok &&
		err.Code == abejson.ErrRPCInvalidParams.Code {
		return c.legacyGetBlockAbeRequest(hash, verbose, verboseTx)
	}
...
/*func (c *Client) GetBlockAsync(blockHash *chainhash.Hash) FutureGetBlockResult {
	...
	cmd := abejson.NewGetBlockCmd(hash, abejson.Int(0))
...
func (c *Client) GetBlockAbeAsync(blockHash *chainhash.Hash) FutureGetBlockAbeResult {
	hash := ""
	if blockHash != nil {
		hash = blockHash.String()
	}

	cmd := abejson.NewGetBlockAbeCmd(hash, abejson.Int(0))
	return FutureGetBlockAbeResult{
		client:   c,
		hash:     hash,
		Response: c.sendCmd(cmd),
	}
...
// See GetBlockVerbose to retrieve a data structure with information about the
// block instead.
func (c *Client) GetBlockAbe(blockHash *chainhash.Hash) (*wire.MsgBlockAbe, error) {
	return c.GetBlockAbeAsync(blockHash).Receive()
}
...
/*func (r FutureGetBlockVerboseResult) Receive() (*abejson.GetBlockVerboseResult, error) {
	...
	var blockResult abejson.GetBlockVerboseResult
...
func (r FutureGetBlockAbeVerboseResult) Receive() (*abejson.GetBlockAbeVerboseResult, error) {
	...
	// Unmarshal the raw result into a BlockResult.
	var blockResult abejson.GetBlockAbeVerboseResult
	err = json.Unmarshal(res, &blockResult)
	if err != nil {
		return nil, err
	}
...
/*func (c *Client) GetBlockVerboseAsync(blockHash *chainhash.Hash) FutureGetBlockVerboseResult {
	...
	cmd := abejson.NewGetBlockCmd(hash, abejson.Int(1))
...
func (c *Client) GetBlockAbeVerboseAsync(blockHash *chainhash.Hash) FutureGetBlockAbeVerboseResult {
	...
	// From the bitcoin-cli getblock documentation:
	// "If verbosity is 1, returns an Object with information about block ."
	cmd := abejson.NewGetBlockAbeCmd(hash, abejson.Int(1))
	return FutureGetBlockAbeVerboseResult{
		client:   c,
		hash:     hash,
		Response: c.sendCmd(cmd),
	}
...
/*func (r FutureGetBlockVerboseTxResult) Receive() (*abejson.GetBlockVerboseTxResult, error) {
	...
	var blockResult abejson.GetBlockVerboseTxResult
	err = json.Unmarshal(res, &blockResult)
	if err != nil {
		return nil, err
	}
...
func (r FutureGetBlockAbeVerboseTxResult) Receive() (*abejson.GetBlockAbeVerboseTxResult, error) {
	...
	var blockResult abejson.GetBlockAbeVerboseTxResult
	err = json.Unmarshal(res, &blockResult)
	if err != nil {
		return nil, err
	}
...
/*func (c *Client) GetBlockVerboseTxAsync(blockHash *chainhash.Hash) FutureGetBlockVerboseTxResult {
	...
	cmd := abejson.NewGetBlockCmd(hash, abejson.Int(2))
...
func (c *Client) GetBlockAbeVerboseTxAsync(blockHash *chainhash.Hash) FutureGetBlockAbeVerboseTxResult {
	...
	// If verbosity is 2, returns an Object with information about block
	// and information about each transaction.
	cmd := abejson.NewGetBlockAbeCmd(hash, abejson.Int(2))
	return FutureGetBlockAbeVerboseTxResult{
		client:   c,
		hash:     hash,
		Response: c.sendCmd(cmd),
	}
...
func (c *Client) GetBlockCountAsync() FutureGetBlockCountResult {
	cmd := abejson.NewGetBlockCountCmd()
	return c.sendCmd(cmd)
}
...
func (r FutureGetChainTxStatsResult) Receive() (*abejson.GetChainTxStatsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	var chainTxStats abejson.GetChainTxStatsResult
...
func (c *Client) GetChainTxStatsAsync() FutureGetChainTxStatsResult {
	cmd := abejson.NewGetChainTxStatsCmd(nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetChainTxStatsNBlocksAsync(nBlocks int32) FutureGetChainTxStatsResult {
	cmd := abejson.NewGetChainTxStatsCmd(&nBlocks, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetChainTxStatsNBlocksBlockHashAsync(nBlocks int32, blockHash chainhash.Hash) FutureGetChainTxStatsResult {
	hash := blockHash.String()
	cmd := abejson.NewGetChainTxStatsCmd(&nBlocks, &hash)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetChainTxStats() (*abejson.GetChainTxStatsResult, error) {
...
func (c *Client) GetChainTxStatsNBlocks(nBlocks int32) (*abejson.GetChainTxStatsResult, error) {
...
func (c *Client) GetChainTxStatsNBlocksBlockHash(nBlocks int32, blockHash chainhash.Hash) (*abejson.GetChainTxStatsResult, error) {
...
func (c *Client) GetDifficultyAsync() FutureGetDifficultyResult {
	cmd := abejson.NewGetDifficultyCmd()
	return c.sendCmd(cmd)
}
...
func unmarshalPartialGetBlockChainInfoResult(res []byte) (*abejson.GetBlockChainInfoResult, error) {
	var chainInfo abejson.GetBlockChainInfoResult
...
func unmarshalGetBlockChainInfoResultSoftForks(chainInfo *abejson.GetBlockChainInfoResult,
	version BackendVersion, res []byte) error {

	switch version {
	// Versions of bitcoind on or after v0.19.0 use the unified format.
	case BitcoindPost19:
		var softForks abejson.UnifiedSoftForks
	...
	default:
		var softForks abejson.SoftForks
		if err := json.Unmarshal(res, &softForks); err != nil {
			return err
		}
...
func (r FutureGetBlockChainInfoResult) Receive() (*abejson.GetBlockChainInfoResult, error) {
...
func (c *Client) GetBlockChainInfoAsync() FutureGetBlockChainInfoResult {
	cmd := abejson.NewGetBlockChainInfoCmd()
...
// of the main chain.
func (c *Client) GetBlockChainInfo() (*abejson.GetBlockChainInfoResult, error) {
...
func (c *Client) GetBlockHeaderAsync(blockHash *chainhash.Hash) FutureGetBlockHeaderResult {
	...
	cmd := abejson.NewGetBlockHeaderCmd(hash, abejson.Bool(false))
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockHeaderVerboseResult) Receive() (*abejson.GetBlockHeaderVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a string.
	var bh abejson.GetBlockHeaderVerboseResult
...
func (c *Client) GetBlockHeaderVerboseAsync(blockHash *chainhash.Hash) FutureGetBlockHeaderVerboseResult {
	...
	cmd := abejson.NewGetBlockHeaderCmd(hash, abejson.Bool(true))
	return c.sendCmd(cmd)
}
...
// its hash.
func (r FutureGetMempoolEntryResult) Receive() (*abejson.GetMempoolEntryResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var mempoolEntryResult abejson.GetMempoolEntryResult
...
func (c *Client) GetMempoolEntryAsync(txHash string) FutureGetMempoolEntryResult {
	cmd := abejson.NewGetMempoolEntryCmd(txHash)
	return c.sendCmd(cmd)
}

// GetMempoolEntry returns a data structure with information about the
// transaction in the memory pool given its hash.
func (c *Client) GetMempoolEntry(txHash string) (*abejson.GetMempoolEntryResult, error) {
...
func (c *Client) GetRawMempoolAsync() FutureGetRawMempoolResult {
	cmd := abejson.NewGetRawMempoolCmd(abejson.Bool(false))
	return c.sendCmd(cmd)
}
...
func (r FutureGetRawMempoolVerboseResult) Receive() (map[string]abejson.GetRawMempoolVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// results.
	var mempoolItems map[string]abejson.GetRawMempoolVerboseResult
...
func (c *Client) GetRawMempoolVerboseAsync() FutureGetRawMempoolVerboseResult {
	cmd := abejson.NewGetRawMempoolCmd(abejson.Bool(true))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawMempoolVerbose() (map[string]abejson.GetRawMempoolVerboseResult, error) {
...
func (c *Client) EstimateFeeAsync(numBlocks int64) FutureEstimateFeeResult {
	cmd := abejson.NewEstimateFeeCmd(numBlocks)
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the
// estimated fee.
func (r FutureEstimateSmartFeeResult) Receive() (*abejson.EstimateSmartFeeResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	var verified abejson.EstimateSmartFeeResult
...
func (c *Client) EstimateSmartFeeAsync(confTarget int64, mode *abejson.EstimateSmartFeeMode) FutureEstimateSmartFeeResult {
	cmd := abejson.NewEstimateSmartFeeCmd(confTarget, mode)
	return c.sendCmd(cmd)
}

// EstimateSmartFee requests the server to estimate a fee level based on the given parameters.
func (c *Client) EstimateSmartFee(confTarget int64, mode *abejson.EstimateSmartFeeMode) (*abejson.EstimateSmartFeeResult, error) {
...
func (c *Client) VerifyChainAsync() FutureVerifyChainResult {
	cmd := abejson.NewVerifyChainCmd(nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainLevelAsync(checkLevel int32) FutureVerifyChainResult {
	cmd := abejson.NewVerifyChainCmd(&checkLevel, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainBlocksAsync(checkLevel, numBlocks int32) FutureVerifyChainResult {
	cmd := abejson.NewVerifyChainCmd(&checkLevel, &numBlocks)
	return c.sendCmd(cmd)
}
...
// NOTE: This is a btcsuite extension ported from
// github.com/decred/dcrrpcclient.
func (r FutureRescanBlocksResult) Receive() ([]abejson.RescannedBlock, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	var rescanBlocksResult []abejson.RescannedBlock
...
func (c *Client) RescanBlocksAsync(blockHashes []chainhash.Hash) FutureRescanBlocksResult {
	...
	cmd := abejson.NewRescanBlocksCmd(strBlockHashes)
	return c.sendCmd(cmd)
}
...
// NOTE: This is a btcsuite extension ported from
// github.com/decred/dcrrpcclient.
func (c *Client) RescanBlocks(blockHashes []chainhash.Hash) ([]abejson.RescannedBlock, error) {
...
func (c *Client) InvalidateBlockAsync(blockHash *chainhash.Hash) FutureInvalidateBlockResult {
	...
	cmd := abejson.NewInvalidateBlockCmd(hash)
	return c.sendCmd(cmd)
}
...
//	todo(ABE): ABE does not support filer.
...
//	}
//
//	cmd := abejson.NewGetCFilterCmd(hash, filterType)
//	return c.sendCmd(cmd)
//}
//
...
//	}
//
//	cmd := abejson.NewGetCFilterHeaderCmd(hash, filterType)
//	return c.sendCmd(cmd)
//}
//
...
//func (r FutureGetBlockStatsResult) Receive() (*abejson.GetBlockStatsResult, error) {
//	res, err := receiveFuture(r)
//	if err != nil {
//		return nil, err
//	}
//
//	var blockStats abejson.GetBlockStatsResult
...
//	}
//
//	cmd := abejson.NewGetBlockStatsCmd(abejson.HashOrHeight{Value: hashOrHeight}, stats)
//	return c.sendCmd(cmd)
//}
//
...
//func (c *Client) GetBlockStats(hashOrHeight interface{}, stats *[]string) (*abejson.GetBlockStatsResult, error) {
