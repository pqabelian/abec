...
func (c *Client) AddNodeAsync(host string, command AddNodeCommand) FutureAddNodeResult {
	cmd := abejson.NewAddNodeCmd(host, abejson.AddNodeSubCmd(command))
...
func (c *Client) NodeAsync(command abejson.NodeSubCmd, host string,
	connectSubCmd *string) FutureNodeResult {
	cmd := abejson.NewNodeCmd(command, host, connectSubCmd)
	return c.sendCmd(cmd)
}
...
func (c *Client) Node(command abejson.NodeSubCmd, host string,
...
func (r FutureGetAddedNodeInfoResult) Receive() ([]abejson.GetAddedNodeInfoResult, error) {
	...
	var nodeInfo []abejson.GetAddedNodeInfoResult
...
func (c *Client) GetAddedNodeInfoAsync(peer string) FutureGetAddedNodeInfoResult {
	cmd := abejson.NewGetAddedNodeInfoCmd(true, &peer)
	return c.sendCmd(cmd)
}
...
// peers.
func (c *Client) GetAddedNodeInfo(peer string) ([]abejson.GetAddedNodeInfoResult, error) {
...
func (c *Client) GetAddedNodeInfoNoDNSAsync(peer string) FutureGetAddedNodeInfoNoDNSResult {
	cmd := abejson.NewGetAddedNodeInfoCmd(false, &peer)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetConnectionCountAsync() FutureGetConnectionCountResult {
	cmd := abejson.NewGetConnectionCountCmd()
	return c.sendCmd(cmd)
}
...
// the current network.
func (r FutureGetNetworkInfoResult) Receive() (*abejson.GetNetworkInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var networkInfo abejson.GetNetworkInfoResult
...
func (c *Client) GetNetworkInfoAsync() FutureGetNetworkInfoResult {
	cmd := abejson.NewGetNetworkInfoCmd()
	return c.sendCmd(cmd)
}

// GetNetworkInfo returns data about the current network.
func (c *Client) GetNetworkInfo() (*abejson.GetNetworkInfoResult, error) {
...
func (r FutureGetPeerInfoResult) Receive() ([]abejson.GetPeerInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as an array of getpeerinfo result objects.
	var peerInfo []abejson.GetPeerInfoResult
...
func (c *Client) GetPeerInfoAsync() FutureGetPeerInfoResult {
	cmd := abejson.NewGetPeerInfoCmd()
	return c.sendCmd(cmd)
}

// GetPeerInfo returns data about each connected network peer.
func (c *Client) GetPeerInfo() ([]abejson.GetPeerInfoResult, error) {
...
// traffic statistics.
func (r FutureGetNetTotalsResult) Receive() (*abejson.GetNetTotalsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var totals abejson.GetNetTotalsResult
...
func (c *Client) GetNetTotalsAsync() FutureGetNetTotalsResult {
	cmd := abejson.NewGetNetTotalsCmd()
	return c.sendCmd(cmd)
}

// GetNetTotals returns network traffic statistics.
func (c *Client) GetNetTotals() (*abejson.GetNetTotalsResult, error) {
