...
func (r FutureGetTransactionResult) Receive() (*abejson.GetTransactionResult, error) {
	...
	var getTx abejson.GetTransactionResult
...
func (c *Client) GetTransactionAsync(txHash *chainhash.Hash) FutureGetTransactionResult {
	...
	cmd := abejson.NewGetTransactionCmd(hash, nil)
...
func (r FutureListTransactionsResult) Receive() ([]abejson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var transactions []abejson.ListTransactionsResult
...
func (c *Client) ListTransactionsAsync(account string) FutureListTransactionsResult {
	cmd := abejson.NewListTransactionsCmd(&account, nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListTransactions(account string) ([]abejson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountAsync(account string, count int) FutureListTransactionsResult {
	cmd := abejson.NewListTransactionsCmd(&account, &count, nil, nil)
	return c.sendCmd(cmd)
}
...
// different options.
func (c *Client) ListTransactionsCount(account string, count int) ([]abejson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountFromAsync(account string, count, from int) FutureListTransactionsResult {
	cmd := abejson.NewListTransactionsCmd(&account, &count, &from, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListTransactionsCountFrom(account string, count, from int) ([]abejson.ListTransactionsResult, error) {
...
func (r FutureListUnspentResult) Receive() ([]abejson.ListUnspentResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var unspent []abejson.ListUnspentResult
...
func (c *Client) ListUnspentAsync() FutureListUnspentResult {
	cmd := abejson.NewListUnspentCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinAsync(minConf int) FutureListUnspentResult {
	cmd := abejson.NewListUnspentCmd(&minConf, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAsync(minConf, maxConf int) FutureListUnspentResult {
	cmd := abejson.NewListUnspentCmd(&minConf, &maxConf, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []abeutil.Address) FutureListUnspentResult {
	addrStrs := make([]string, 0, len(addrs))
	for _, a := range addrs {
		addrStrs = append(addrStrs, a.EncodeAddress())
	}

	cmd := abejson.NewListUnspentCmd(&minConf, &maxConf, &addrStrs)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspent() ([]abejson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMin(minConf int) ([]abejson.ListUnspentResult, error) {
...
// a filter.
func (c *Client) ListUnspentMinMax(minConf, maxConf int) ([]abejson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []abeutil.Address) ([]abejson.ListUnspentResult, error) {
...
func (r FutureListSinceBlockResult) Receive() (*abejson.ListSinceBlockResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var listResult abejson.ListSinceBlockResult
...
func (c *Client) ListSinceBlockAsync(blockHash *chainhash.Hash) FutureListSinceBlockResult {
	var hash *string
	if blockHash != nil {
		hash = abejson.String(blockHash.String())
	}

	cmd := abejson.NewListSinceBlockCmd(hash, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListSinceBlock(blockHash *chainhash.Hash) (*abejson.ListSinceBlockResult, error) {
...
func (c *Client) ListSinceBlockMinConfAsync(blockHash *chainhash.Hash, minConfirms int) FutureListSinceBlockResult {
	...
	cmd := abejson.NewListSinceBlockCmd(hash, &minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListSinceBlockMinConf(blockHash *chainhash.Hash, minConfirms int) (*abejson.ListSinceBlockResult, error) {
...
func (c *Client) LockUnspentAsync(unlock bool, ops []*wire.OutPoint) FutureLockUnspentResult {
	outputs := make([]abejson.TransactionInput, len(ops))
	for i, op := range ops {
		outputs[i] = abejson.TransactionInput{
			Txid: op.Hash.String(),
			Vout: op.Index,
		}
	}
...
func (r FutureListLockUnspentResult) Receive() ([]*wire.OutPoint, error) {
	...
	var inputs []abejson.TransactionInput
...
func (c *Client) ListLockUnspentAsync() FutureListLockUnspentResult {
	cmd := abejson.NewListLockUnspentCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) SetTxFeeAsync(fee abeutil.Amount) FutureSetTxFeeResult {
	cmd := abejson.NewSetTxFeeCmd(fee.ToABE())
	return c.sendCmd(cmd)
}
...
func (c *Client) SetTxFee(fee abeutil.Amount) error {
...
func (c *Client) SendToAddressAsync(address abeutil.Address, amount abeutil.Amount) FutureSendToAddressResult {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress abeutil.Address, amount abeutil.Amount) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := abejson.NewSendFromCmd(fromAccount, addr, amount.ToABE(), nil,
		nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress abeutil.Address, amount abeutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress abeutil.Address, amount abeutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := abejson.NewSendFromCmd(fromAccount, addr, amount.ToABE(),
		&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress abeutil.Address, amount abeutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress abeutil.Address, amount abeutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress abeutil.Address,
	amount abeutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[abeutil.Address]abeutil.Amount) FutureSendManyResult {
	convertedAmounts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmounts[addr.EncodeAddress()] = amount.ToABE()
	}
	cmd := abejson.NewSendManyCmd(fromAccount, convertedAmounts, nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[abeutil.Address]abeutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[abeutil.Address]abeutil.Amount,
	...
	cmd := abejson.NewSendManyCmd(fromAccount, convertedAmounts,
		&minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[abeutil.Address]abeutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (abeutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []abeutil.Address, account string) FutureAddMultisigAddressResult {
...
func (r FutureCreateMultisigResult) Receive() (*abejson.CreateMultiSigResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var multisigRes abejson.CreateMultiSigResult
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []abeutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}

	cmd := abejson.NewCreateMultisigCmd(requiredSigs, addrs)
	return c.sendCmd(cmd)
}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []abeutil.Address) (*abejson.CreateMultiSigResult, error) {
...
func (c *Client) CreateNewAccountAsync(account string) FutureCreateNewAccountResult {
	cmd := abejson.NewCreateNewAccountCmd(account)
	return c.sendCmd(cmd)
}
...
// address.
func (r FutureGetNewAddressResult) Receive() (abeutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddressAsync(account string) FutureGetNewAddressResult {
	cmd := abejson.NewGetNewAddressCmd(&account)
	return c.sendCmd(cmd)
}

// GetNewAddress returns a new address.
func (c *Client) GetNewAddress(account string) (abeutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (abeutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddressAsync(account string) FutureGetRawChangeAddressResult {
	cmd := abejson.NewGetRawChangeAddressCmd(&account)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawChangeAddress(account string) (abeutil.Address, error) {
...
// address.
func (r FutureAddWitnessAddressResult) Receive() (abeutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddWitnessAddressAsync(address string) FutureAddWitnessAddressResult {
	cmd := abejson.NewAddWitnessAddressCmd(address)
	return c.sendCmd(cmd)
}

// AddWitnessAddress adds a witness address for a script and returns the new
// address (P2SH of the witness script).
func (c *Client) AddWitnessAddress(address string) (abeutil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (abeutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddressAsync(account string) FutureGetAccountAddressResult {
	cmd := abejson.NewGetAccountAddressCmd(account)
	return c.sendCmd(cmd)
}

// GetAccountAddress returns the current Bitcoin address for receiving payments
// to the specified account.
func (c *Client) GetAccountAddress(account string) (abeutil.Address, error) {
...
func (c *Client) GetAccountAsync(address abeutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
	cmd := abejson.NewGetAccountCmd(addr)
	return c.sendCmd(cmd)
}

// GetAccount returns the account associated with the passed address.
func (c *Client) GetAccount(address abeutil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address abeutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
	cmd := abejson.NewSetAccountCmd(addr, account)
	return c.sendCmd(cmd)
}

// SetAccount sets the account associated with the passed address.
func (c *Client) SetAccount(address abeutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]abeutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]abeutil.Address, 0, len(addrStrings))
	for _, addrStr := range addrStrings {
		addr, err := abeutil.DecodeAddress(addrStr,
...
func (c *Client) GetAddressesByAccountAsync(account string) FutureGetAddressesByAccountResult {
	cmd := abejson.NewGetAddressesByAccountCmd(account)
	return c.sendCmd(cmd)
}

// GetAddressesByAccount returns the list of addresses associated with the
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]abeutil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount abeutil.Amount) FutureMoveResult {
	cmd := abejson.NewMoveCmd(fromAccount, toAccount, amount.ToABE(), nil,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) Move(fromAccount, toAccount string, amount abeutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount abeutil.Amount, minConfirms int) FutureMoveResult {

	cmd := abejson.NewMoveCmd(fromAccount, toAccount, amount.ToABE(),
		&minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount abeutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount abeutil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount abeutil.Amount,
...
func (c *Client) RenameAccountAsync(oldAccount, newAccount string) FutureRenameAccountResult {
	cmd := abejson.NewRenameAccountCmd(oldAccount, newAccount)
	return c.sendCmd(cmd)
}
...
func (r FutureValidateAddressResult) Receive() (*abejson.ValidateAddressWalletResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var addrResult abejson.ValidateAddressWalletResult
...
func (c *Client) ValidateAddressAsync(address abeutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
	cmd := abejson.NewValidateAddressCmd(addr)
	return c.sendCmd(cmd)
}

// ValidateAddress returns information about the given bitcoin address.
func (c *Client) ValidateAddress(address abeutil.Address) (*abejson.ValidateAddressWalletResult, error) {
...
func (c *Client) KeyPoolRefillAsync() FutureKeyPoolRefillResult {
	cmd := abejson.NewKeyPoolRefillCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) KeyPoolRefillSizeAsync(newSize uint) FutureKeyPoolRefillResult {
	cmd := abejson.NewKeyPoolRefillCmd(&newSize)
	return c.sendCmd(cmd)
}
...
func (r FutureListAccountsResult) Receive() (map[string]abeutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]abeutil.Amount)
	for k, v := range accounts {
		amount, err := abeutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccountsAsync() FutureListAccountsResult {
	cmd := abejson.NewListAccountsCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListAccounts() (map[string]abeutil.Amount, error) {
...
func (c *Client) ListAccountsMinConfAsync(minConfirms int) FutureListAccountsResult {
	cmd := abejson.NewListAccountsCmd(&minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]abeutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (abeutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := abeutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (abeutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalanceAsync(account string) FutureGetBalanceResult {
	cmd := abejson.NewGetBalanceCmd(&account, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBalance(account string) (abeutil.Amount, error) {
...
func (c *Client) GetBalanceMinConfAsync(account string, minConfirms int) FutureGetBalanceResult {
	cmd := abejson.NewGetBalanceCmd(&account, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (abeutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (abeutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAccountAsync(account string) FutureGetReceivedByAccountResult {
	cmd := abejson.NewGetReceivedByAccountCmd(account, nil)
	return c.sendCmd(cmd)
}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (abeutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConfAsync(account string, minConfirms int) FutureGetReceivedByAccountResult {
	cmd := abejson.NewGetReceivedByAccountCmd(account, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (abeutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (abeutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalanceAsync(account string) FutureGetUnconfirmedBalanceResult {
	cmd := abejson.NewGetUnconfirmedBalanceCmd(&account)
	return c.sendCmd(cmd)
}

// GetUnconfirmedBalance returns the unconfirmed balance from the server for
// the specified account.
func (c *Client) GetUnconfirmedBalance(account string) (abeutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (abeutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address abeutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := abejson.NewGetReceivedByAddressCmd(addr, nil)
	return c.sendCmd(cmd)
...
// confirmations.
func (c *Client) GetReceivedByAddress(address abeutil.Address) (abeutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address abeutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := abejson.NewGetReceivedByAddressCmd(addr, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAddressMinConf(address abeutil.Address, minConfirms int) (abeutil.Amount, error) {
...
// Receive waits for the response promised by the future and returns a list of
// balances by account.
func (r FutureListReceivedByAccountResult) Receive() ([]abejson.ListReceivedByAccountResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []abejson.ListReceivedByAccountResult
...
func (c *Client) ListReceivedByAccountAsync() FutureListReceivedByAccountResult {
	cmd := abejson.NewListReceivedByAccountCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccount() ([]abejson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountMinConfAsync(minConfirms int) FutureListReceivedByAccountResult {
	cmd := abejson.NewListReceivedByAccountCmd(&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountMinConf(minConfirms int) ([]abejson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAccountResult {
	cmd := abejson.NewListReceivedByAccountCmd(&minConfirms, &includeEmpty,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountIncludeEmpty(minConfirms int, includeEmpty bool) ([]abejson.ListReceivedByAccountResult, error) {
...
// Receive waits for the response promised by the future and returns a list of
// balances by address.
func (r FutureListReceivedByAddressResult) Receive() ([]abejson.ListReceivedByAddressResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []abejson.ListReceivedByAddressResult
	err = json.Unmarshal(res, &received)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListReceivedByAddressAsync() FutureListReceivedByAddressResult {
	cmd := abejson.NewListReceivedByAddressCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddress() ([]abejson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressMinConfAsync(minConfirms int) FutureListReceivedByAddressResult {
	cmd := abejson.NewListReceivedByAddressCmd(&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
// received any payments in the results.
func (c *Client) ListReceivedByAddressMinConf(minConfirms int) ([]abejson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAddressResult {
	cmd := abejson.NewListReceivedByAddressCmd(&minConfirms, &includeEmpty,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddressIncludeEmpty(minConfirms int, includeEmpty bool) ([]abejson.ListReceivedByAddressResult, error) {
...
func (c *Client) WalletPassphrase(passphrase string, timeoutSecs int64) error {
	cmd := abejson.NewWalletPassphraseCmd(passphrase, timeoutSecs)
...
func (c *Client) WalletPassphraseChangeAsync(old, new string) FutureWalletPassphraseChangeResult {
	cmd := abejson.NewWalletPassphraseChangeCmd(old, new)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignMessageAsync(address abeutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
	cmd := abejson.NewSignMessageCmd(addr, message)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address abeutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address abeutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
	cmd := abejson.NewVerifyMessageCmd(addr, signature, message)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address abeutil.Address, signature, message string) (bool, error) {
...
//// (WIF)
//func (r FutureDumpPrivKeyResult) Receive() (*abeutil.WIF, error) {
//	res, err := receiveFuture(r)
//	if err != nil {
//		return nil, err
//	}
...
//	}
//
//	return abeutil.DecodeWIF(privKeyWIF)
//}
//
...
//func (c *Client) DumpPrivKeyAsync(address abeutil.Address) FutureDumpPrivKeyResult {
//	addr := address.EncodeAddress()
//	cmd := abejson.NewDumpPrivKeyCmd(addr)
//	return c.sendCmd(cmd)
//}
//
...
//// NOTE: This function requires to the wallet to be unlocked.  See the
//// WalletPassphrase function for more details.
//func (c *Client) DumpPrivKey(address abeutil.Address) (*abeutil.WIF, error) {
...
//	cmd := abejson.NewImportAddressCmd(address, "", nil)
//	return c.sendCmd(cmd)
//}
//
...
//	cmd := abejson.NewImportAddressCmd(address, account, &rescan)
//	return c.sendCmd(cmd)
//}
//
...
//func (c *Client) ImportPrivKeyAsync(privKeyWIF *abeutil.WIF) FutureImportPrivKeyResult {
//	wif := ""
//	if privKeyWIF != nil {
//		wif = privKeyWIF.String()
//	}
//
//	cmd := abejson.NewImportPrivKeyCmd(wif, nil, nil)
//	return c.sendCmd(cmd)
//}
//
//// ImportPrivKey imports the passed private key which must be the wallet import
//// format (WIF).
//func (c *Client) ImportPrivKey(privKeyWIF *abeutil.WIF) error {
...
////
//// See ImportPrivKey for the blocking version and more details.
//func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *abeutil.WIF, label string) FutureImportPrivKeyResult {
//	wif := ""
//	if privKeyWIF != nil {
//		wif = privKeyWIF.String()
//	}
//
//	cmd := abejson.NewImportPrivKeyCmd(wif, &label, nil)
//	return c.sendCmd(cmd)
//}
//
...
//func (c *Client) ImportPrivKeyLabel(privKeyWIF *abeutil.WIF, label string) error {
...
////
//// See ImportPrivKey for the blocking version and more details.
//func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *abeutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
//	wif := ""
//	if privKeyWIF != nil {
//		wif = privKeyWIF.String()
//	}
//
//	cmd := abejson.NewImportPrivKeyCmd(wif, &label, &rescan)
//	return c.sendCmd(cmd)
//}
//
...
//func (c *Client) ImportPrivKeyRescan(privKeyWIF *abeutil.WIF, label string, rescan bool) error {
...
//	cmd := abejson.NewImportPubKeyCmd(pubKey, nil)
//	return c.sendCmd(cmd)
//}
//
...
//	cmd := abejson.NewImportPubKeyCmd(pubKey, &rescan)
//	return c.sendCmd(cmd)
//}
//
...
func (r FutureGetInfoResult) Receive() (*abejson.InfoWalletResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes abejson.InfoWalletResult
...
func (c *Client) GetInfo() (*abejson.InfoWalletResult, error) {
