...
type KnownNetAddress struct {
	na          *wire.NetAddress
	srcNetAddr  *wire.NetAddress
	attempts    int
...
// known address.
func (ka *KnownNetAddress) NetAddress() *wire.NetAddress {
	return ka.na
}

// LastAttempt returns the last time the known address was attempted.
func (ka *KnownNetAddress) LastAttempt() time.Time {
	return ka.lastattempt
}

// Services returns the services supported by the peer with the known address.
func (ka *KnownNetAddress) Services() wire.ServiceFlag {
...
func (ka *KnownNetAddress) chance() float64 {
	now := time.Now()
...
func (ka *KnownNetAddress) isBad() bool {
