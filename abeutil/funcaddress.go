...
func NewMasterAddressSalrsMasterPubKey(serializedMasterPubKey []byte) (*MasterAddressSalrs, error) {
	masterPubKey, err := salrs.DeseralizeMasterPubKey(serializedMasterPubKey)
	if err != nil {
		return nil, err
	}
