...
//	todo(ABE): Just to help, will be removed.
import (
	"bytes"
	"crypto/hmac"
	"crypto/rand"
...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := abeutil.Hash160(k.pubKeyBytes())[:4]
...
func (k *ExtendedKey) Address(net *chaincfg.Params) (*abeutil.AddressPubKeyHash, error) {
	pkHash := abeutil.Hash160(k.pubKeyBytes())
	return abeutil.NewAddressPubKeyHash(pkHash, net)
}
...
func (k *ExtendedKey) String() string {
	...
	// todo: doubleHash: does not matter, is not used and will be removed
