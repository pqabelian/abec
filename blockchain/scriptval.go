...
//	todo(ABE): implement after wallet's design, as the transactions are generated by wallet
//	ValidateTransactionWitnesses
func ValidateTransactionScriptsAbe(tx *abeutil.TxAbe, utxoRingView *UtxoRingViewpoint) error {
	...
	//	For SALRS, the can be done by simple compuattion with public values;
...
//	Abe to do
func checkBlockScriptsAbe(block *abeutil.BlockAbe, utxoRingView *UtxoRingViewpoint,
	scriptFlags txscript.ScriptFlags, sigCache *txscript.SigCache,
	hashCache *txscript.HashCache) error {
