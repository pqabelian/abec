/*
abec is a full-node bitcoin implementation written in Go.

The default options are sane for most users.  This means abec will work 'out of
...
parsed when abec starts up.  By default, the configuration file is located at
~/.abec/abec.conf on POSIX-style operating systems and %LOCALAPPDATA%\abec\abec.conf
