...
type AbeCtxTxOutputDesc struct {
	cryptoAddress []byte // generated by CryptoAddressKeyGen
	value         uint64
}

func (a AbeCtxTxOutputDesc) CryptoAddress() []byte {
	return a.cryptoAddress
}

func (a AbeCtxTxOutputDesc) Value() uint64 {
	return a.value
}

// NewAbeTxOutDesc constructs a new AbeTxOutputDesc from the input (cryptoAddress []byte, value uint64).
// reviewed on 2023.12.07
func NewAbeCtxTxOutDesc(cryptoAddress []byte, value uint64) *AbeTxOutputDesc {
...
type AbeCtxTxInputDescByRootSeeds struct {
...
// todo: review
type AbeCtxTxInputDescByRandSeeds struct {
	// ringId        *wire.RingId  // txoRing identifier
	txoRing                     *wire.TxoRing                // complete TxoRing information
	sidx                        uint8                        // spend which one
	cryptoScheme                abecryptoxparam.CryptoScheme // address, generated by CryptoAddressKeyGen
...
// todo: review
type AbeCtxTxInputDescByKeys struct {
	txoRing           *wire.TxoRing // complete TxoRing information
	sidx              uint8         // spend which one
...
// todo: review
func NewAbeCtxTxInputDescByRootSeeds(
...
func NewAbeCtxTxInputDescByRandSeeds(
	txoRing *wire.TxoRing, sidx uint8,
	cryptoScheme abecryptoxparam.CryptoScheme, privacyLevel abecryptoxkey.PrivacyLevel,
...
// reviewed on 2023.12.21
func NewAbeCtxTxInputDescByKeys(
	txoRing *wire.TxoRing, sidx uint8,
	cryptoAddress []byte,
...
// reviewed on 2023.12.21
func NewAbeCtxTxInDetail(ringId wire.RingId, txoList []*wire.TxOutAbe, serialNumber []byte) *AbeTxInDetail {
