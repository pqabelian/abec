...
type AbeTxInputDescByRootSeeds struct {
	...
	coinSerialNumberKeyRootSeed []byte // coinSerialNumberKeyRootSeed, provided by the caller of abecrypto
	coinValueKeyRootSeed        []byte // coinValueKeyRootSeed, provided by the caller of abecrypto
...
type AbeTxInputDescByRandSeeds struct {
	...
	coinSerialNumberKeyRandSeed []byte // coinSerialNumberKeyRandSeed, provided by the caller of abecrypto
	coinValueKeyRandSeed        []byte // coinValueKeyRandSeed, provided by the caller of abecrypto
